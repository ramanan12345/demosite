# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-01-17 13:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='contact.ContactUsFormPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
